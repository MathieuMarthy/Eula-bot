...
class RiotRankService:
    ...
    def store_player(self, guildId: int, discordId: int, player_id: str, puuid: str, riotName: str, rank_data: Optional[list[dict]] = None, profile_icon_id: Optional[int] = None):
